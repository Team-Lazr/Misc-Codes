...
# Usage: curl -fsSL https://raw.githubusercontent.com/harshbuddhadev/Misc-Codes/refs/heads/main/Bash/setup_kali_env.sh -o /tmp/setup_vm.sh && sudo bash /tmp/setup_vm.sh && rm /tmp/setup_vm.sh
